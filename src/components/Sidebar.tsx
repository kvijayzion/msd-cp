...
const Sidebar: React.FC<SidebarProps> = ({ isDarkMode }) => {
  ...
  return (
    <div className={`fixed left-4 top-1/2 transform -translate-y-1/2 w-20 z-40 flex flex-col items-center space-y-6 p-4 rounded-3xl transition-all duration-500 ${
      isDarkMode
        ? 'bg-gray-900'
        : 'bg-gray-50'
    }`}
